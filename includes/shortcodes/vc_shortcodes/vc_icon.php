...
<div <?php echo implode( ' ', $wrapper_attributes ); ?> class="vc_icon_element m-0 vc_icon_element-outer<?php echo strlen( $css_class ) > 0 ? ' ' . trim( esc_attr( $css_class ) ) : ''; ?> vc_icon_element-align-<?php echo esc_attr( $align );
	if ( $has_style ) {
        ...
        <div class="increase-shortcode-icon">
        ...
        <?php if ( ! empty( $title ) || ! empty( $description ) ) { ?>
            ...
            <div class="increase-shortcode-icon-content">
...
<?php } else { ?>
    ...
    <div <?php echo implode( ' ', $wrapper_attributes ); ?> class="vc_icon_element vc_icon_element-outer<?php echo strlen( $css_class ) > 0 ? ' ' . trim( esc_attr( $css_class ) ) : ''; ?> vc_icon_element-align-<?php echo esc_attr( $align );
    if ( $has_style ) {
        echo ' vc_icon_element-have-style';
    } ?>">
