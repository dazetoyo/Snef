...
<?php
// $taxonomies = get_object_taxonomies( $post_type, 'act_propuneri' );
// $exclude = array('limba');
?>
...
<div class="row" style="padding-bottom:130px">
    <div class="col-12 ">
        <h5 class="text-danger">
            ...
            II. Propuneri de acțiuni viitoare în domeniul educației ​​financiare  </h5>
        </div>
        ...
        <form  class="col-12 col-xl-3 mt-5" action="<?php echo site_url() ?>/wp-admin/admin-ajax.php" method="POST" id="filter">
            ...
            if( $terms = get_terms(array('taxonomy' => 'audienta_tintita-2','orderby' => 'name', 'hide_empty' => false ))){?>
                <div class="col-12 px-0">
                    <p class="pt-2 h5"> CĂUTARE AVANSATĂ </p>
                    <div class="box-carte">
                        <div class="row">
                            <div class="col-10">
                    ...
                    <?php
                    if( $terms = get_terms(array('taxonomy' => 'instrumentul-2','orderby' => 'name',
                 'hide_empty' => false ))){?>
                        <div class="col-12 px-0">
                            <div class="box-carte">
            ...
            <?php
            if( $terms = get_terms(array('taxonomy' => 'resurse-2','orderby' => 'name',
        'hide_empty' => false ))){?>
                <div class="col-12 px-0">
                    <div class="box-carte">
            ...
            <?php
            if( $terms = get_terms(array('taxonomy' => 'institutia-2','orderby' => 'name',
        'hide_empty' => false ))){?>
                <div class="col-12 px-0">
...
jQuery(function($){
    ...
    $('#filter').change(function(){
        ...
        $.ajax({
            ...
            data:filter.serialize()+'&action=filter_autoritati2', // form data
        ...
        $.ajax({
            ...
            data:filter.serialize()+'&action=filter_mediuprivat2', // form data
            type:filter.attr('method'), // POST
            beforeSend:function(xhr){
                filter.find('button').text('Processing...'); // changing the button label
            },
        ...
        $.ajax({
            url:filter.attr('action'),
            data:filter.serialize()+'&action=filter_ong2', // form data
            type:filter.attr('method'), // POST
            beforeSend:function(xhr){
                filter.find('button').text('Processing...'); // changing the button label
            },
        ...
        $.ajax({
            url:filter.attr('action'),
            data:filter.serialize()+'&action=filter_toate2', // form data
